...
const Banner = () => {
  ...
  return (
    <section className="h-[calc(100vh-12vh)] md:h-[82vh] w-full border bg-hero bg-no-repeat bg-cover bg-center relative">
      ...
      <div className="relative container mx-auto flex flex-col items-center justify-center h-full z-20 px-4 lg:pt-60  pt-60">
        <div className="bg-black/50  rounded-sm p-6 md:p-12 shadow-lg">
          <h1 className="text-white text-3xl md:text-5xl lg:text-6xl font-bold text-center leading-tight drop-shadow-lg">
